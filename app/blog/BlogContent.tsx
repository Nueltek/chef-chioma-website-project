...
const fallbackPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "After years of perfecting my jollof rice technique in professional kitchens across three continents, I'm sharing the secrets that make my version stand out.",
    featuredImage: {
  ...
  },
  {
    ...
    excerpt:
      "Egusi soup is more than a dish—it's a canvas for creativity. Learn how to select the best melon seeds at the market.",
    featuredImage: {
  ...
  },
  {
    ...
    excerpt:
      "A look inside the meticulous planning, early mornings, and coordinated chaos that goes into delivering a memorable wedding feast.",
    featuredImage: {
  ...
  },
  {
    ...
    excerpt:
      "Suya is Nigeria's beloved street food, but in my kitchen, it becomes something more refined.",
    featuredImage: {
      url: "https://images.unsplash.com/photo-1432139555190-58524dae6a55?w=800&q=80",
      alt: "Suya Spices",
    },
  ...
  },
  {
    ...
    excerpt:
      "Palm oil has been central to West African cooking for centuries. Let's explore its culinary uses and health considerations.",
    featuredImage: {
  ...
  },
  {
    ...
    excerpt:
      "Every chef has an origin story. Mine begins in a modest kitchen in Enugu, where my grandmother taught me that cooking is about love.",
    featuredImage: {
      ...
      <section className="relative min-h-[50vh] md:min-h-[60vh] flex items-center bg-earth-900 overflow-hidden pt-20 md:pt-0">
        ...
        <div className="container-main relative text-center py-12 md:py-20">
          ...
          <motion.p
            ...
            className="font-body text-sm md:text-base lg:text-body-lg text-cream/80 max-w-2xl mx-auto mb-6 md:mb-8 px-4"
          >
            Recipes, stories, and culinary wisdom from my kitchen to yours.
          </motion.p>
          ...
          >
            <div className="relative">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 md:w-5 md:h-5 text-cream/50" />
              <input
                type="text"
            ...
            >
              <Link href={`/blog/${featuredPost.slug}`} className="group block">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
                  <div className="relative aspect-[16/10] rounded-sm overflow-hidden bg-earth-100">
                    <Image
                      ...
                      priority
                    />
                    <div className="absolute top-3 left-3 md:top-4 md:left-4 bg-copper text-cream px-2 md:px-3 py-1 rounded-sm">
              ...
              >
                {regularPosts.map((post, index) => (
                  ...
                  >
                    <Link
                      href={`/blog/${post.slug}`}
                      className="block bg-white rounded-sm overflow-hidden shadow-sm hover:shadow-md transition-shadow"
                    >
