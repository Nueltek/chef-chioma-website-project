    ...
    <section className="relative bg-cream py-16 lg:py-32 overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8 lg:gap-16 opacity-40">
          {['Forbes Africa', 'CNN', 'Guardian Life', 'Bella Naija'].map((name) => (
            <span 
              key={name} 
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                animate={isBadgeInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.8 }}
              ...
              >
                <span className="font-display text-3xl md:text-4xl lg:text-5xl block">15+</span>
                <span className="font-sans text-[10px] md:text-xs uppercase tracking-widest text-cream/70">Years of Excellence</span>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4 md:space-y-5 mb-6 md:mb-8">
              <p className="font-body text-sm md:text-base lg:text-body-lg text-text-secondary leading-relaxed">
                Welcome to a new chapter of private dining. Chef Chioma Okonkwo brings 
                the soulful depth of West African cuisine to your most cherished gatherings, 
                delivering Michelin-caliber experiences with the warmth of home.
              </p>
              
              <p className="font-body text-sm md:text-base text-text-secondary leading-relaxed">
                Born in Enugu and trained in the world&apos;s finest kitchens—from Le Cordon Bleu 
                Paris to the legendary establishments of London and Dubai—Chef Chioma has 
                spent over fifteen years perfecting her craft.
              </p>

              <p className="font-body text-sm md:text-base text-text-secondary leading-relaxed hidden md:block">
                Every dish tells a story. Of grandmother&apos;s recipes reimagined. Of local 
                ingredients sourced with intention. Of a heritage too rich to be contained 
                by borders.
              </p>
            </div>
            ...
            <blockquote className="border-l-2 border-copper pl-4 md:pl-6 mb-6 md:mb-8">
              <p className="font-display text-base md:text-lg lg:text-xl italic text-earth-800">
                &ldquo;Food is memory made edible. I don&apos;t just cook—I translate love, 
                history, and belonging onto a plate.&rdquo;
              </p>
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 md:gap-3 font-sans text-xs md:text-sm uppercase tracking-widest text-earth-800 group"
            >
