...
const variants: Record<ButtonVariant, string> = {
  ...
  outline:
    "bg-transparent text-earth-800 border-earth-800 hover:bg-earth-800 hover:text-cream",
  light:
    "bg-cream text-earth-800 border-cream hover:bg-transparent hover:text-cream",
