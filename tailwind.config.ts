...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        // Display font - elegant serif (uses next/font CSS variable)
        display: [
          "var(--font-display)",
          "Playfair Display",
          "Georgia",
        ...
        // Script font for accents (uses next/font CSS variable)
        script: ["var(--font-script)", "Dancing Script", "cursive"],
        // Body font - refined serif (uses next/font CSS variable)
        body: ["var(--font-body)", "Georgia", "serif"],
        // Sans for UI elements (uses next/font CSS variable)
